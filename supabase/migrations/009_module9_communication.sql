...
-- ─────────────────────────────────────────────────────────────
CREATE TABLE procedure_stakeholders (
...
CREATE INDEX idx_stakeholders_plan        ON procedure_stakeholders(plan_id);
CREATE INDEX idx_stakeholders_specialist  ON procedure_stakeholders(specialist_id);
CREATE INDEX idx_stakeholders_mobile      ON procedure_stakeholders(mobile)
  WHERE mobile IS NOT NULL;
CREATE INDEX idx_stakeholders_role        ON procedure_stakeholders(plan_id, role);
CREATE INDEX idx_stakeholders_pending     ON procedure_stakeholders(plan_id)
...
CREATE INDEX idx_threads_plan        ON communication_threads(plan_id);
CREATE INDEX idx_threads_specialist  ON communication_threads(specialist_id);
CREATE INDEX idx_threads_stakeholder ON communication_threads(stakeholder_id);
...
CREATE INDEX idx_events_thread      ON communication_events(thread_id, created_at DESC);
CREATE INDEX idx_events_plan        ON communication_events(plan_id, created_at DESC);
CREATE INDEX idx_events_specialist  ON communication_events(specialist_id);
CREATE INDEX idx_events_whatsapp_id ON communication_events(whatsapp_msg_id)
...
CREATE INDEX idx_confirmations_thread     ON confirmation_requests(thread_id);
CREATE INDEX idx_confirmations_plan       ON confirmation_requests(plan_id);
CREATE INDEX idx_confirmations_pending    ON confirmation_requests(plan_id)
  WHERE is_resolved = FALSE;
CREATE INDEX idx_confirmations_overdue    ON confirmation_requests(response_required_by)
...
-- ─────────────────────────────────────────────────────────────
CREATE TABLE patient_adherence_log (
  id                UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  plan_id           UUID NOT NULL,
  specialist_id     UUID NOT NULL REFERENCES specialists(id) ON DELETE CASCADE,
...
CREATE INDEX idx_adherence_plan       ON patient_adherence_log(plan_id);
CREATE INDEX idx_adherence_specialist ON patient_adherence_log(specialist_id);
CREATE INDEX idx_adherence_date       ON patient_adherence_log(plan_id, check_date);
...
CREATE INDEX idx_escalation_plan      ON escalation_rules(plan_id);
CREATE INDEX idx_escalation_specialist ON escalation_rules(specialist_id);
...
CREATE INDEX idx_escalation_events_plan       ON escalation_events(plan_id);
CREATE INDEX idx_escalation_events_specialist ON escalation_events(specialist_id);
CREATE INDEX idx_escalation_events_unresolved ON escalation_events(plan_id)
...
-- ─────────────────────────────────────────────────────────────
CREATE TABLE post_procedure_milestones (
  id                UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  plan_id           UUID NOT NULL,
  specialist_id     UUID NOT NULL REFERENCES specialists(id) ON DELETE CASCADE,
...
CREATE INDEX idx_milestones_plan      ON post_procedure_milestones(plan_id);
CREATE INDEX idx_milestones_specialist ON post_procedure_milestones(specialist_id);
CREATE INDEX idx_milestones_pending   ON post_procedure_milestones(plan_id)
...
CREATE INDEX idx_comm_templates_specialist ON communication_templates(specialist_id);
CREATE INDEX idx_comm_templates_role       ON communication_templates(role, trigger_event);
CREATE INDEX idx_comm_templates_specialty  ON communication_templates(specialty);
...
-- ─────────────────────────────────────────────────────────────
-- FUNCTION: get_pending_confirmations
